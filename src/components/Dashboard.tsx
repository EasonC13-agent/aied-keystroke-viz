      ...
      <>
        <header className="text-center py-10 px-5 relative" style={{ background: "var(--card)", borderBottom: "1px solid var(--border)" }}>
          <div className="absolute top-4 right-4 flex gap-2">
            ...
            <a href="https://github.com/EasonC13-agent/aied-keystroke-viz" target="_blank" rel="noopener" className="px-3 py-1.5 border rounded-md text-sm no-underline inline-flex items-center" style={{ borderColor: "var(--border)", background: "var(--card)", color: "var(--muted)" }}>GitHub</a>
