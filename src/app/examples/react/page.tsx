  ...
  return (
    <>
      <div className="flex items-center gap-2 text-sm mb-6">
        <a href="https://github.com/EasonC13-agent/aied-keystroke-viz/tree/main/examples/react" target="_blank" rel="noopener" style={{ color: "var(--accent)" }}>View source on GitHub ↗</a>
